...
const mock = [
  {
    ...
    position_dates: ['Fullstack Engineer |', ' 01/2022 - Present'],
    position_overview:
  ...
  },
  {
    ...
    position_dates: 'ELA Teacher | 08/2020 - 08/2021',
    position_overview:
    'Strengthened the English track literature department, post-covid, by providing staff training on teach ELA to ESOL learners. Taught and mentored two 4 grade classes.',
    accomplishments: [
      'Jointly prepared curriculums, benchmark testing, and extra-curriculuar activities for 4 grade cohort; which allowed for data tracking of the academic and emotional progress of students returning to school after months of home schooling.',
  ...
  },
  {
    ...
    position_dates: 'Adjunct Lecturer | 08/2017 - 08/2020',
    position_overview:
    ...
    accomplishments: [
      ...
      'Implemented the Content-based ESL curriculum; which allowed for the college to successful hire foreign talents and meet departmental staffing goals.',
    ]
  },
];
