...
const mock = [
  {
    ...
    position_dates: ['S3 | CloudFront | Route 53 | Lambda | Dynamo DB | Github Actions | Terraform | React | Python'],
    project_overview:
    ...
    accomplishments: [
      ...
      'Developed the UI in React with stateless functional components, and a Lambda function in Python which retreives data from a table created in Dynamo DB',
      'Assigned custom Domain to CloudFront with SSL Certificate with Route 53 for static hosting.',
  ...
  {
    comapny: ['Pandas - Jupyter Notebooks', ' ', <a href='https://github.com/rlondon3/Data-Analysis-w-Pandas-1' style={{ fontSize: '1.2rem'}}>View Source Code</a>],
    ...
    accomplishments: [
      ...
      'Transform datatypes and clean data.',
      'Find mean, average, standard deviation, and other metrics for understanding the meaning of Wind Speed data as it relates to weather conditions.',
      'Created PowerBI visualizations from Pandas metrics.'
    ]
  },
  {
    comapny: ['NY Times Bestsellers Frontend', ' ', <a href='https://alluring-bears.surge.sh/' style={{ fontSize: '1.2rem'}}>View Site</a>],
    position_dates: ['React | Material UI | Context API | React Hooks | Joi Validation' ],
    project_overview:
     'This is a ReactJS Frontend that calls the New York Times Bestsellers API to dynamically render the top 15 best sellers in a table.',
    accomplishments: [
      'Implemented a Context API for state management over React components.',
      'Dynamical render components based on data received from API.',
      'Created multiple reusable components with a well organized file system.',
    ]
  },
  {
    comapny: ['User Authentication Backend', ' ', <a href='https://github.com/rlondon3/authenticate-user' style={{ fontSize: '1.2rem'}}>View Source Code</a>],
    position_dates: ['Node.js | Express | Jasmine | MongoDB | Mongoose | Docker | JSON Webtoken | Bcrypt | Unit Testing | Joi' ],
    project_overview:
    ...
    accomplishments: [
      ...
      'Used Express for request and response between the client and server of the JWTs.',
      'Spec tests using the Jasmine library for user schema, routes, and authentication middleware.',
...
const Projects = () => {
  ...
  return (
    <Box bgcolor="alternate.main">
      <Container>
        <Typography variant='h5' style={{fontWeight: 700, paddingTop: '20px', textAlign: !isSm ? 'start' : '', paddingLeft: !isSm ? '30px' : ''}}>TECHNICAL PROJECTS</Typography>
        <List
          sx={{
            width: '100%',
